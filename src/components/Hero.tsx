        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Nexus is a  landing page & marketing website template for
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                className="px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md hover:cursor-pointer  dark:hover:bg-purple-800 hover:bg-purple-700"
              >
                Download for Free
              </a>
              <a
                href="https://github.com/MostafaAwad1/Nexus"
                target="_blank"
                rel="noopener"
              ...
              >
                ...
                <span className="dark:hover:text-gray-50 hover:text-slate-800"> View on Github</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
              <AmazonLogo />
            </div>
            <div className="text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
              <VerizonLogo />
            </div>
            <div className="text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
              <MicrosoftLogo />
            </div>
            <div className="pt-1 text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
              <NetflixLogo />
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
              <SonyLogo />
